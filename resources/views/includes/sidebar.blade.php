<div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          @php
              // Path saat ini tanpa leading slash, dipakai untuk menandai menu aktif
              $current = request()->path() === '/' ? 'dashboard' : request()->path();
          @endphp
          <ul class="sidebar-menu">
                ...
                @endif
                <li class="dropdown {{ request()->is('permohonan*') || request()->is('riwayat-permohonan') ? 'active' : '' }}">
                ...
                <ul class="dropdown-menu">
                    <li class="{{ request()->is('permohonan') ? 'active' : '' }}"><a href="/permohonan">Permohonan</a></li>
                    @if(auth()->user()->role_id == 2 || auth()->user()->role_id == 3 || auth()->user()->role_id == 4)
                    <li class="{{ request()->is('riwayat-permohonan') ? 'active' : '' }}"><a href="/riwayat-permohonan">Riwayat Permohonan</a></li>
                    @endif
                    <li class="{{ request()->is('permohonan-disetujui') ? 'active' : '' }}"><a href="/permohonan-disetujui">Permohonan Disetujui</a></li>
                    <li class="{{ request()->is('permohonan-ditolak') ? 'active' : '' }}"><a href="/permohonan-ditolak">Permohonan Ditolak</a></li>
                    <li class="{{ request()->is('permohonan-dibatalkan') ? 'active' : '' }}"><a href="/permohonan-dibatalkan">Permohonan Dibatalkan</a></li>
                </ul>
                </li>
        </ul>
        </aside>
